<?php
	...
	if(isset($_SESSION["identificador"]) && $_SESSION["identificador"] == session_id() && $_SESSION["id_tipo"] == 2){
		if((time() - $_SESSION["tiempo_inicio"]) > 7200){
			...
			$numReporte = (int)$_POST['numero_reporte'];
	...
	<main style="width: 100%;">		
		<section style="width: 100%;">
			<div class="container mb-5">
				<form name="formulario" action="../comunicacion/actualizar_reporte.php" method="POST" enctype="multipart/form-data">
					...
					<div class="tab-content" id="myTabContent">
						<!-- Inicio Información -->
  						<div class="tab-pane fade show active" id="informacion" role="tabpanel" aria-labelledby="informacion-tab">
							...
							<div class="row mt-3">
								<div class="form-floating mb-0 col-md">
									<input type="text" class="form-control" id="floatingInput" placeholder="Mandante" name="mandante" value="<?php echo $fila_proyecto[6]; ?>" required>
									<label for="floatingInput" id="valorInput">&nbsp;(*) Mandante</label>
								</div>
							</div>
							<div class="row mt-3">
								<div class="form-floating mb-0 col-md">
									<input type="text" class="form-control" id="floatingInput" placeholder="Contratista" name="contratista" value="<?php echo $fila_proyecto[7]; ?>" required>
									<label for="floatingInput" id="valorInput">&nbsp;(*) Contratista</label>
								</div>
							</div>
							<div class="row mt-3">
								<div class="form-floating mb-0 col-md">
									<input type="text" class="form-control" id="floatingInput" placeholder="Inspector T&eacute;cnico" name="inspector_tecnico" value="<?php echo $fila_proyecto[8]; ?>" required>
							...
							<div class="row mt-3">
								...
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="text" class="form-control" id="floatingInput" placeholder="Sector de Trabajo / Calle" name="sector_trabajo" value="<?php echo $fila_trabajo[3]; ?>" required>
									<label for="floatingInput" class="tamanoLetra" id="valorInput">&nbsp;(*) Sector de Trabajo / Calle</label>									
								</div>		
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="text" class="form-control" id="floatingInput" placeholder="Lugar de Trabajo" name="lugar_trabajo" value="<?php echo $fila_trabajo[4]; ?>" required>
		  				...
		  				<div class="tab-pane fade" id="reporte" role="tabpanel" aria-labelledby="repote-tab">
							...
							<div class="row mt-0">
								<div class="form-floating mb-0 col-md">
									<input type="time" class="form-control fw-bold"  id="floatingInput" placeholder="Inicio" name="hh_inicio_normal" value="<?php echo $fila_horas[3]; ?>" onblur="restarhoras()">
									<label for="floatingInput" id="valorInput">&nbsp;Inicio</label>
								</div>					
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Termino" name="hh_termino_normal" value="<?php echo $fila_horas[5]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Termino</label>
								</div>						
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Informe" name="hh_informe_normal" value="<?php echo $fila_horas[7]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Informe</label>
								</div>										
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Trayecto" name="hh_trayecto_normal" value="<?php echo $fila_horas[11]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Trayecto</label>
								</div>
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Total" value="0" name="hh_total_normal" value="<?php echo $fila_horas[9]; ?>" readonly>	
							...
							<div class="row mt-0">
								<div class="form-floating mb-0 col-md">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Inicio" name="hh_inicio_extras" value="<?php echo $fila_horas[4]; ?>" onblur="restarhoras()">
									<label for="floatingInput" id="valorInput">&nbsp;Inicio</label>
								</div>										
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Termino" name="hh_termino_extras" value="<?php echo $fila_horas[6]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Termino</label>
								</div>
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Informe" name="hh_informe_extras" value="<?php echo $fila_horas[8]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Informe</label>			
								</div>
								<div class="form-floating mb-0 col-md" id="margeInput">
									<input type="time" class="form-control fw-bold" id="floatingInput" placeholder="Trayecto" name="hh_trayecto_extras" value="<?php echo $fila_horas[12]; ?>" onblur="restarhoras()">	
									<label for="floatingInput" id="valorInput">&nbsp;Trayecto</label>			
								</div>
								<div class="form-floating mb-0 col-md" id="margeInput">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 200 caracteres" name="equipo_contratista" rows="5" maxlength="200"><?php echo $fila_equipoeecc[3]; ?></textarea>					
								</div>
							</div>							
							<div class="row mt-3 ms-1 me-1 bg-success pt-3 pb-3">						
								<div class="form-floating mb-0 col-md">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 500 caracteres" name="actividades" rows="5" maxlength="600"><?php echo $fila_texto[3]; ?></textarea>																	
								</div>
							</div>
							<div class="row mt-3 ms-1 me-1 bg-success pt-3 pb-3">  												
								<div class="mb-0 col-md">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 500 caracteres" rows="5" name="hallazgos" maxlength="600"><?php echo $fila_texto[4]; ?></textarea>									
								</div>								
							</div>
							<div class="row mt-3 ms-1 me-1 bg-success pt-3 pb-3">  												
								<div class="mb-0 col-md">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 500 caracteres" rows="5" name="actividades_calidad" maxlength="600"><?php echo $fila_texto[5]; ?></textarea>
								</div>								
							</div>
							<div class="row mt-3 ms-1 me-1 bg-success pt-3 pb-3">  												
								<div class="mb-0 col-md">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 500 caracteres" rows="5" name="topico_reunion" maxlength="600"><?php echo $fila_texto[6]; ?></textarea>
								</div>								
							</div>
							<div class="row mt-3 ms-1 me-1 bg-success pt-3 pb-3">  												
								<div class="mb-0 col-md">
							...
							<div class="row mt-3">
								<div class="mb-0 col-md">
									<textarea class="form-control" id="" placeholder="M&aacute;ximo 500 caracteres" rows="5" name="incidentes" maxlength="600"><?php echo $fila_texto[7]; ?></textarea>
								</div>								
							</div>	
						</div>						
		  				<!-- Fin Reporte -->
