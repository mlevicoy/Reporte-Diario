														...
														if($resultado){
															...
															while($filas = $nueva_conexion->obtenerFilas($resultado)){
																...
																echo "<tr>";
						      									...
						      									echo "<td>";
																echo "<a title='Descargar Archivo' href='" . $archivo . "' download='" . $archivo . "' style='color: #224875; font-size:18px;'>"; 
					      										echo "<i class='fa-solid fa-download'></i>";
					      										echo "</a>";
						      									echo "</td>";
						      									echo "<td>";
						      									echo "<a title='Enviar Archivo' href='enviarBuscador.php?val=" . $filas[0] . "&val2=" . $filas[1] . "' style='color: #224875; font-size:18px;'>";
