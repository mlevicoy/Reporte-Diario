...
?>
			...
			<body class="d-flex flex-column min-vh-100">
			   			...
			   			<div class="container-fluid">
			   				...
			   				<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
			   					<div class="navbar-nav iconos-navbar-1">
			   						<a href="<?php echo $menu; ?>" class="nav-link active" aria-current="page" href="#" style="color:#FFFFFF; font-weight: bolder;">
			   					...
			   					<div class="navbar-nav iconos-navbar-2">
			   						<a href="<?php echo $menu; ?>" class="nav-link active" aria-current="page" href="#" style="color:#FFFFFF !important; font-weight: bolder; text-align: center;">
				...
				<main>
					<section>
						<div class="container">
							<form action="../comunicacion/guardar_contrasena.php" method="POST">
								<?php
									if(isset($_GET["val"]) && $_GET["val"] == 1){
								?>
										<div class="alert alert-primary" role="alert">
											La contraseña se ha <b>cambiado</b> correctamente.	
										</div>
								<?php
									}
									else if(isset($_GET["val"]) && $_GET["val"] == 2){
								?>
										<div class="alert alert-primary" role="alert">
											Ha ocurrido un <b>error</b>. Intentar de nuevo.	
										</div>
								<?php
									}
								?>
								...
								<div class=" row justify-content-md-center">
									<div class="col-md-8 col-lg-8 col-12">
										<div class="form-floating">
											<input type="password" class="form-control" id="floatingInputGrid" placeholder="Contrase&ntilde;a Actual" name="contrasena_actual" required autofocus>
											<label for="floatingInputGrid">Contraseña Actual</label>
										</div>
									</div>									
								</div>	
								<div class=" row justify-content-md-center mt-3 mb-3">
								...
								<div class=" row justify-content-md-center">
									<div class="col-md">
										<div class="row mt-3 d-grid gap-1 col-6 mx-auto">
											<button class="btn btn-primary" type="submit" style="background-color: #224875;">Guardar</button>
										</div>
									</div>
								</div>
							</form>
