	...
	if(isset($_SESSION["identificador"]) && $_SESSION["identificador"] == session_id() && $_SESSION["id_tipo"] == 1){
		if((time() - $_SESSION["tiempo_inicio"]) > 7200){
			...
			if(isset($_GET["val"])){
				...
				$_SESSION["numero_usuario"] = $_GET["val2"];				
			}
?>
			<!DOCTYPE html>
			<html lang="es">
				...
				<article style="width: 100%;">
					<section style="width: 100%;">
						<div class="container text-center table-responsive">
							<form action="../comunicacion/enviarBuscador.php" method="POST">  								
								<table class="table mt-3">
									<thead>
										<tr scope="col">
											<th class="text-start" scope="col" colspan="4"><b>Ingresar destinatario</b>:</th>
										</tr>										
									</thead>
									<tbody>	
										<tr>
											<td>
												<input type="text" name="grupoDestinatario" value="" required class="w-100 mt-3" autofocus>
											</td>																													
										</tr>
										<tr>
											<td class="text-start">
												<label>(Puede agregar m&aacute;s de un correo separados por coma)</label>
											</td>																													
										</tr>										
	    							</tbody>
								</table>
