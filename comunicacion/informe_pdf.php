	...
	if((time() - $_SESSION["tiempo_inicio"]) > 7200){
		...
		class PDF extends FPDF{
			...
			function Header(){
				...
				$query = "SELECT revision_reporte FROM reporte WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		...
		$query = "SELECT * FROM proyecto WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		...
		if($result){
			...
			$pdf->SetXY(94.667,$y);
			$pdf->MultiCell(55.667, $h,strtoupper(utf8_decode(html_entity_decode("CONTRATISTA"))), "LT", "C", true);
			$pdf->SetXY(149.334,$y);
		...
		$query = "SELECT * FROM reporte WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query2 = "SELECT * FROM trabajo WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		...
		$query = "SELECT * FROM plazo_trabajo WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query2 = "SELECT * FROM horas WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		$result2 = $nuevaConexion->ejecutarConsulta($query2);
		if($result && $result2){
		...
		$query = "SELECT * FROM personaleecc WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query2 = "SELECT * FROM equipoeecc WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query3 = "SELECT * FROM trabajadores WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		...
		if($result && $result2 && $result3){
			...
			$h_aux = 0;
			$pdf->MultiCell(65.33, $h+$h_aux, strtoupper(utf8_decode(html_entity_decode($fila_equipoeecc[3]))), "LT", "L", false);
		...
		$query = "SELECT * FROM condicion WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query2 = "SELECT * FROM cumplimiento WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		$result2 = $nuevaConexion->ejecutarConsulta($query2);
		if($result && $result2){
		...
		$query = "SELECT * FROM texto WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$query2 = "SELECT * FROM localizacion WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		$result2 = $nuevaConexion->ejecutarConsulta($query2);
		if($result && $result2){
			$fila_condicion = $nuevaConexion->obtenerFilas($result);
		...
		$query = "SELECT * FROM imagenes WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		...
		$query = "SELECT * FROM libro WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
		$result = $nuevaConexion->ejecutarConsulta($query);
		$filas_afectadas = $nuevaConexion->obtenerFilasAfectadas();
		...
		if(!file_exists("../archivos/" . $_SESSION["id_usuario"])){
			mkdir("../archivos/" . $_SESSION["id_usuario"] . "/");	
		}			

		//$pdf->Output();
		$pdf->Output("F", "../archivos/" . $_SESSION["id_usuario"] . "/reporteDiario_N" . $numeroReporte . ".pdf");

		//Movimiento
		$fecha = date("Y-m-d");
		$titulo = "REPORTE DIARIO";
		$descripcion = "Usuario ha generado el reporte diario N&deg;" . $numeroReporte . " el " . $nuevaConexion->enviarFechaHora();
		$ruta = "../archivos/" . $_SESSION["id_usuario"] . "/reporteDiario_N" . $numeroReporte . ".pdf";
		$array_descripcion = array($_SESSION["id_usuario"], $titulo, $descripcion, $ruta, $fecha);
		...
		header("Location: ../interfaz/enviar.php");
	}
}
else{
	header("Location: cerrar_sesion.php");
