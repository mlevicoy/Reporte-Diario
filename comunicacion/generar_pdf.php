<?php
	...
	if(isset($_SESSION["identificador"]) && $_SESSION["identificador"] == session_id() && $_SESSION["id_tipo"] == 2){
		if((time() - $_SESSION["tiempo_inicio"]) > 7200){
			...
			$query = "SELECT * FROM trabajadores WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
			$query2 = "SELECT * FROM avance WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
			$query3 = "SELECT * FROM horas WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
			$result = $nuevaConexion->ejecutarConsulta($query);
			$result2 = $nuevaConexion->ejecutarConsulta($query2);
			...
			$query = "SELECT * FROM equipoeecc WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
			$query2 = "SELECT * FROM personaleecc WHERE id_reporte = $numeroReporte AND id_usuario = " . $_SESSION["id_usuario"];
			$result = $nuevaConexion->ejecutarConsulta($query);
			$result2 = $nuevaConexion->ejecutarConsulta($query2);
			if($result && $result2){
